...
# These are listed in the same order as in the System Setup Web UI.
...
class AqualinkColorLight(AqualinkLight, AqualinkDevice):
    ...
    # TODO: Could rename this to effect_name for clarity.
    @property
    def effect(self) -> typing.Optional[str]:
        # The API seems to return "state"=1 no matter what effect is currently chosen.
